...
3. Allowlist additions name a first issue (number, title, url) and a parsed `aiPolicy`.
4. Tests: `node --experimental-strip-types --test src/lib/foundry/policy.test.ts`
